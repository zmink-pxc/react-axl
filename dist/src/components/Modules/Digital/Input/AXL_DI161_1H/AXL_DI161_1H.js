...
function (_React$PureComponent) {
  _inherits(AXL_DI161_1H, _React$PureComponent);

  function AXL_DI161_1H(props) {
    _classCallCheck(this, AXL_DI161_1H);

    return _possibleConstructorReturn(this, _getPrototypeOf(AXL_DI161_1H).call(this, props));
  }

  _createClass(AXL_DI161_1H, [{
    key: "render",
...
//# sourceMappingURL=AXL_DI161_1H.jsx.map