...
function (_React$PureComponent) {
  _inherits(AXL_RTD4_1H, _React$PureComponent);

  function AXL_RTD4_1H(props) {
    _classCallCheck(this, AXL_RTD4_1H);

    return _possibleConstructorReturn(this, _getPrototypeOf(AXL_RTD4_1H).call(this, props));
  }

  _createClass(AXL_RTD4_1H, [{
    key: "render",
...
//# sourceMappingURL=AXL_RTD4_1H.jsx.map