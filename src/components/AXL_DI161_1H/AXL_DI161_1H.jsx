...
export default class AXL_DI161_1H extends React.PureComponent {
    ...
    render(){
        return (
            <AXL_Module partName="DI16/1" width={35} terminals={this.props.terminals} leds={this.props.leds} raisedMidsection={false} hasTopRow={false} partNumber="2688310" labels={['a','0','1','2','3']} colorCard={{isDigitalIn:true}}>
