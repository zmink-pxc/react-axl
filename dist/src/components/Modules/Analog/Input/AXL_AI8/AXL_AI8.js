...
function (_React$PureComponent) {
  _inherits(AXL_AI8, _React$PureComponent);

  function AXL_AI8(props) {
    _classCallCheck(this, AXL_AI8);

    return _possibleConstructorReturn(this, _getPrototypeOf(AXL_AI8).call(this, props));
  }

  _createClass(AXL_AI8, [{
    key: "render",
...
exports["default"] = AXL_AI8;
AXL_AI8.defaultProps = {
  partName: 'AI8',
  partNumber: 2688064,
  terminals: (0, _AXL_Module.defaultTerminals)(36),
  leds: (0, _AXL_Module.defaultLeds)(36)
};

//# sourceMappingURL=AXL_AI8.jsx.map