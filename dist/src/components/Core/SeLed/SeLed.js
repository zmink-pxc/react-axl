...
var SeLed = /*#__PURE__*/function (_React$PureComponent) {
  _inherits(SeLed, _React$PureComponent);

  var _super = _createSuper(SeLed);

  function SeLed(props) {
    _classCallCheck(this, SeLed);
