...
var AxlLedGroup = /*#__PURE__*/function (_React$PureComponent) {
  _inherits(AxlLedGroup, _React$PureComponent);

  var _super = _createSuper(AxlLedGroup);

  function AxlLedGroup(props) {
    _classCallCheck(this, AxlLedGroup);
...
//# sourceMappingURL=AxlLedGroup.jsx.map