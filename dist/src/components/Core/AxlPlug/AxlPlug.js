...
var AxlPlug = /*#__PURE__*/function (_React$PureComponent) {
  _inherits(AxlPlug, _React$PureComponent);

  var _super = _createSuper(AxlPlug);

  function AxlPlug(props) {
    _classCallCheck(this, AxlPlug);
