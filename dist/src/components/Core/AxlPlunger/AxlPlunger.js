...
var AxlPlunger = /*#__PURE__*/function (_React$PureComponent) {
  _inherits(AxlPlunger, _React$PureComponent);

  var _super = _createSuper(AxlPlunger);

  function AxlPlunger(props) {
    _classCallCheck(this, AxlPlunger);
