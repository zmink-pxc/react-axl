...
export default class AXL_AI8 extends React.PureComponent {
    ...
    render(){
        return (
            <AXL_Module {...this.props} partName={this.props.partName} width={53.6} terminals={this.props.terminals} leds={this.props.leds} raisedMidsection={false} hasTopRow={false} partNumber={this.props.partNumber} labels={['a','0','1','2','3','4','5','6','7']} colorCard={{isAnalogIn:true}}>
